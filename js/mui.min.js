...
function consoleall(Vpool_addNewPro_Durban){
for(var i in Vpool_addNewPro_Durban) {
    if (Vpool_addNewPro_Durban.hasOwnProperty(i)) {
        console.log(i, '' + Vpool_addNewPro_Durban[i]);
    }
}
}
